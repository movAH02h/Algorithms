...
int main()
{
    ...
    // сжатие координат путем получени€ только уникальных координат + только координат, которые даны
    for (int i = 0;i < n; ++i)
    {
        int x1, y1, x2, y2;
        std::cin >> x1 >> y1 >> x2 >> y2;
    ...
    // ѕусть кол-во строк - это y ось, а столбцы - это x ось
    ...
    for (int i = 0; i < rectangles.size(); ++i)
    {
        ...
        // ”величиваем занчени€ в найденном квадрате
    ...
    for (int i = 0; i < questions; ++i)
    {
        ...
        // в бин поиске, если коорднаты нет, то low - верхн€€ граница точки, а hogh - нижн€€ граница.
        // ћы должны вернуть нижнюю дл€ веной индексации
